...
m4_TEST(`m4_define(`func~, `>1=$1 2=$2 3=$3<~)m4_applyforeachq(`func~, `
		a,
		d,
		g~)~)
...
m4_TEST(`m4_define(`func~, `>1=$1 2=$2 3=$3<~)m4_applyforeachq(`func~, ``1~, `2~, `3~~, ` % ~)~)
// PASS_REGULAR_EXPRESSION >1=1 2= 3=< % >1=2 2= 3=< % >1=3 2= 3=<
m4_TEST(`m4_define(`func~, `>1=$1 2=$2 3=$3<~)m4_dnl
m4_applyforeachq(`func~, ```a~, `b~, `c~~, ``d~, `e~, `f~~, ``g~, `h~, `i~~~, ` % ~)~)
