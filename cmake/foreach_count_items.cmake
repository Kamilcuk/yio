...
function(foreach_count_items _foreach_count_items_loopvar_name _foreach_count_items_statevar_name)
	...
	if(NOT DEFINED ${_foreach_count_items_statevar_name})
		set(${_foreach_count_items_statevar_name})
	endif()
	set(_foreach_count_items_statevar "${${_foreach_count_items_statevar_name}}")
	if(NOT DEFINED ${_foreach_count_items_loopvar_name})
		set(${_foreach_count_items_loopvar_name})
	endif()
