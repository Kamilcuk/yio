...
int _yIO_print_right(yπio_printctx_t *t) {
	yio_printctx_get_fmt(t)->align = '>';
	return yio_printctx_next(t);
}

int _yIO_print_left(yπio_printctx_t *t) {
	yio_printctx_get_fmt(t)->align = '<';
	return yio_printctx_next(t);
}

int _yIO_print_center(yπio_printctx_t *t) {
	yio_printctx_get_fmt(t)->align = '^';
	return yio_printctx_next(t);
}

int _yIO_print_fixed(yπio_printctx_t *t) {
	yio_printctx_get_fmt(t)->type = 'f';
	return yio_printctx_next(t);
}

int _yIO_print_scientific(yπio_printctx_t *t) {
	yio_printctx_get_fmt(t)->type = 'e';
	return yio_printctx_next(t);
}

int _yIO_print_hexfloat(yπio_printctx_t *t) {
	yio_printctx_get_fmt(t)->type = 'a';
	return yio_printctx_next(t);
}

int _yIO_print_precision(yπio_printctx_t *t) {
	yio_printctx_get_fmt(t)->precision = yio_printctx_va_arg(t, int);
	return yio_printctx_next(t);
}

int _yIO_print_width_size_t(yπio_printctx_t *t) {
	yio_printctx_get_fmt(t)->width = yio_printctx_va_arg(t, size_t);
	return yio_printctx_next(t);
}

int _yIO_print_width(yπio_printctx_t *t) {
	yio_printctx_get_fmt(t)->width = yio_printctx_va_arg(t, int);
	return yio_printctx_next(t);
}

int _yIO_print_unitbuf(yπio_printctx_t *t) {
	yio_printctx_get_fmt(t)->hash = '#';
	return yio_printctx_next(t);
}

int _yIO_print_nounitbuf(yπio_printctx_t *t) {
	yio_printctx_get_fmt(t)->hash = 0;
	return yio_printctx_next(t);
}

int _yIO_print_pfmt(yπio_printctx_t *t) {
