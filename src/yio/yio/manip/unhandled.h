 ...
 * @brief
 */
#ifndef YYIO_YIO_YIO_MANIP_UNHANDLED_H_
#define YYIO_YIO_YIO_MANIP_UNHANDLED_H_
#include "../ctx.h"
...
int (*YYIO_print_unhandled_type(void))(yio_printctx_t *t);
#define YYIO_print_unhandled_type  (YYIO_print_unhandled_type())
#endif /* YYIO_YIO_YIO_MANIP_UNHANDLED_H_ */
