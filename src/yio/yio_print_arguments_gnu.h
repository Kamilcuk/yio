 ...
 * @brief
 */
#ifndef YYIO_YIO_YIO_PRINT_ARGUMENTS_GNU_H_
#define YYIO_YIO_YIO_PRINT_ARGUMENTS_GNU_H_
...
#define YYIO_print_arguments_$1(funcgen, fmt{{j_yio_print_arguments_args(I)}}) \
	__extension__({ static const yio_printdata_t YYIO_printfuncs[] = { \
{{ j_yio_macros_funcs(I) }}		NULL \
	}; YYIO_printfuncs; }), fmt \
{{ j_yio_macros_args(I) }}	/* */
{% endcall %}{% endfor %}
#endif // YYIO_YIO_YIO_PRINT_ARGUMENTS_GNU_H_
