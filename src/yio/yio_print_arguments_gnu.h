 ...
 * @brief
 */
#ifndef YIO_YIO_YIO_PRINT_ARGUMENTS_GNU_H_
#define YIO_YIO_YIO_PRINT_ARGUMENTS_GNU_H_
...
#define YIO_print_arguments_$1(funcgen, fmt{{j_yio_print_arguments_args(I)}}) \
	__extension__({ static const yio_printdata_t YIO_printfuncs[] = { \
{{ j_yio_macros_funcs(I) }}		NULL \
	}; YIO_printfuncs; }), fmt \
{{ j_yio_macros_args(I) }}	/* */
{% endcall %}{% endfor %}
#endif // YIO_YIO_YIO_PRINT_ARGUMENTS_GNU_H_
