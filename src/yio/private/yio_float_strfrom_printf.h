 ...
 */
int YYIO_float_astrfrom_printf_$1(YYIO_string *v, int precision, char spec, YYIO_FLOAT_REPR_$1 val);

#if YIO_USE_STRFROM_PRINTF
#  define YYIO_has_float_printf_$1  1
#else
#  define YYIO_has_float_printf_$1  0
#endif
