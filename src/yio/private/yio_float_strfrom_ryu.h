 ...
 * @brief
 */
#ifndef YIO_YIO_PRIVATE_YIO_FLOAT_STRFROM_RYU_H_
#define YIO_YIO_PRIVATE_YIO_FLOAT_STRFROM_RYU_H_
#ifdef __cplusplus
extern "C" {
#endif
...
{% if V.1 in ["B32", "B64"] %}
#  define YIO_has_float_astrfrom_ryu_$1 1
...
#endif
#endif // YIO_YIO_PRIVATE_YIO_FLOAT_STRFROM_RYU_H_
