...
int main() {
    ...
    err = yio_sprintf(buf, 21, "{}{}", "1234567890", "1234567890");
    ...
    err = yio_sprintf(buf, 21, "{}{}", "1234567890", "12345678901");
    ...
    // So "ABCD" + null.
    char small[5];
    err = yio_sprintf(small, 5, "{}{}", "ABC", "DEFG");
    YIO_TESTEXPR(err == YIO_ERROR_ENOBUFS, "Expected %d, got %d", YIO_ERROR_ENOBUFS, err);
    ...
    char buf10[10];
    err = yio_sprintf(buf10, 10, "{}{}{}{}", "123", "456", "789", "012");
    YIO_TESTEXPR(err == YIO_ERROR_ENOBUFS, "Expected %d, got %d", YIO_ERROR_ENOBUFS, err);
