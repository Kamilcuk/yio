...
static char *(* const f_vpnt)(const yio_printdata_t *, const char *fmt, va_list *va) = yio_vformatf;
static int (* const f_pnt)(const yio_printdata_t *, const char *fmt, ...) = YYIO_yio_printf;
